...
我们可以使用**Chrome开发者工具**获取参数，具体步骤如下：
...
> B站AJAX快速登录页：https://passport.bilibili.com/ajax/miniLogin/minilogin
...
预览文章、添加头图、选择分类、撰写专栏推荐语，这些都是文章发布前的准备工作，手动完成后即可提请发布文章了，当然，B站要审核专栏文章。**目前，B站专栏还不支持修改发布后的专栏文章。**
...
当然，如果想为你的`Markdown`文章添加上B站专有功能，完全可以在使用此工具提交后，再回到B站专栏**富文本编辑器**中手动修改。
